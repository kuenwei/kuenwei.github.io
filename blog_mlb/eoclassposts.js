...
document.writeln('<script src="'+location.protocol+"//"+location.hostname+'/feeds/posts/summary/-/'+listfor+'?max-results=100&alt=json-in-script&callback=recentpostslist"></script>');
